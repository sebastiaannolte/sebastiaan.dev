...
<div class="content container">
    <div class="page">
        ...
        <div class="project">
            ...
            <ul>
                <li>
                    <a href="{{getFullUrl($project->blog_post_id)}}">{{getBlogPostTitle($project->blog_post_id)}}<small
                            class="small-date"> {{$project->created_at->format('d M Y')}}</small></a>
                </li>
            </ul>
    ...
    {{$projects->links('vendor.pagination.simple-default')}}
</div>
